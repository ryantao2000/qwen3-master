...
ds_reason = load_dataset("Ronndy/medical_o1_sft_Chinese",cache_dir='./data/reason',split="train[:1600]")
...
ds_no_reason = load_dataset("BAAI/IndustryInstruction_Health-Medicine",cache_dir = './data/Medicine',split="train[:400]")
